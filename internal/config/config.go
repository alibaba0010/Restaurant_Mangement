...
func LoadConfig() *Config {
	once.Do(func() {
		...
		cfg = &Config{
			...
			FLUTTERWAVE_CLIENT_ID:      getEnv("FLUTTERWAVE_CLIENT_ID", ""),
			FLUTTERWAVE_CLIENT_SECRET:  getEnv("FLUTTERWAVE_CLIENT_SECRET", ""),
			FLUTTERWAVE_ENCRYPTION_KEY: getEnv("FLUTTERWAVE_ENCRYPTION_KEY", ""),
			FLUTTERWAVE_BASE_URL:       getEnv("FLUTTERWAVE_BASE_URL", "https://api.flutterwave.com/v3"),
			FLUTTERWAVE_AUTH_URL:       getEnv("FLUTTERWAVE_AUTH_URL", ""),
