...
// AbortMultipartUploadInput represents the request to abort a multipart upload
...
// UploadMultipartPartResponse is returned after a successful server-proxied part upload
